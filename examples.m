...
%% bitfinex_lendbook
% [response,status]=main_api_call('bitfinex','lendbook',{'coin','btc','limit_bids',50,'limit_asks',50});
%% bitfinex_book
...
%% % % % % % % % % % % % % % % GDAX
%% gdax_currencies
% [response,status]=main_api_call('gdax','currencies','');
...
[response,status]=main_api_call('gdax','accounts',{});
%% % % % % % % % % % % % % % % BITTREX
% [response,status]=main_api_call('bittrex','getmarkets',{});
% [response,status]=main_api_call('bittrex','getcurrencies',{});
% [response,status]=main_api_call('bittrex','getticker',{'market','BTC-DOGE'});
% [response,status]=main_api_call('bittrex','getmarketsummaries',{});
% [response,status]=main_api_call('bittrex','getmarketsummary',{'market','BTC-DOGE'});
% [response,status]=main_api_call('bittrex','getorderbook',{'market','BTC-DOGE','type','buy','depth','50'});
% [response,status]=main_api_call('bittrex','getmarkethistory',{'market','BTC-DOGE','count','21'});
% [response,status]=main_api_call('bittrex','getbalances',{})